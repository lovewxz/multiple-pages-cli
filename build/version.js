...
const tagInfo = child_process.execSync('git tag --points-at HEAD').toString().trim()
...
const diff = child_process.execSync('git diff HEAD^ HEAD --name-only ').toString().trim()
// module.exports = { commit, commitUserName, commitUserMail, commitDate, buildUserName, buildUserMail, buildDate }
module.exports = { commit, commitUserName, commitUserMail, commitDate, buildDate, tagInfo, diff }
